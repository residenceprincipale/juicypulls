...
getSpotLightInfo(spotLight, -vViewPosition, directLight);
...
RE_Direct(directLight, -vViewPosition, normal, normalize(vViewPosition), material, reflectedLight); // not sure
