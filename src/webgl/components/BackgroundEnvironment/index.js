...
export default class BackgroundEnvironment {
    ...
    _createColumnInstances() {
        ...
        this._colonneInstancedMesh = new InstancedMesh(
            colonneMesh.geometry,
            this._columnMaterial,
            instanceCount
        )
    ...
    _createLightInstances() {
        ...
        this._lightInstancedMesh = new InstancedMesh(
            paternLightMesh.geometry,
            this._lightMaterial,
            instanceCount
        )
        ...
        this._lightCubeInstancedMesh = new InstancedMesh(
            cubeGeometry,
            this._whiteLightMaterial,
            instanceCount
        )
    ...
    _createDebug() {
        ...
        lightGridFolder.addBinding(this._lightGridSettings, 'xCount', {
            min: 1,
            max: 20,
            step: 1,
        }).on('change', () => {
        ...
        lightGridFolder.addBinding(this._lightGridSettings, 'zCount', {
            min: 1,
            max: 20,
            step: 1,
        }).on('change', () => {
        ...
        lightGridFolder.addBinding(this._lightGridSettings, 'xSpacing', {
            min: 0.5,
            max: 10,
            step: 0.1,
        }).on('change', () => {
        ...
        lightGridFolder.addBinding(this._lightGridSettings, 'zSpacing', {
            min: 0.5,
            max: 10,
            step: 0.1,
        }).on('change', () => {
        ...
        lightGridFolder.addBinding(this._lightGridSettings, 'yOffset', {
            min: -5,
            max: 15,
            step: 0.1,
        }).on('change', () => {
        ...
        startPositionFolder.addBinding(this._lightGridSettings.startPosition, 'x', {
            min: -20,
            max: 20,
            step: 0.1,
        }).on('change', () => {
        ...
        startPositionFolder.addBinding(this._lightGridSettings.startPosition, 'z', {
            min: -20,
            max: 20,
            step: 0.1,
        }).on('change', () => {
